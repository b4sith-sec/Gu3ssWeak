...
This application is intentionally insecure for **educational purposes only**. The authors are not responsible for misuse. Only use on devices and networks you own or have explicit written permission to test.
